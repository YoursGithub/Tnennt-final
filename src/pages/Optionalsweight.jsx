...
function Optionalsweight() {
    ...
    const [GramOptions] = useState([
        { amount: '50g' },
        { amount: '100g' },
        { amount: '150g' }
    ]);

    const [KilogramOptions] = useState([
        { amount: '1kg' },
        { amount: '1.5kg' },
        { amount: '2kg' }
    ]);
            ...
            <section className="lg:hidden">
                <div className="sticky z-60 bg-white top-0">
                    ...
                    <div className="mx-4 mt-7 mb-7">
                        <div>
                            <button className={`focus:outline-none visited:outline-none active:outline-none category-button-1 border border-black bg-[#343434] text-[#737373] m-1 px-4 py-2 rounded-lg transition-colors duration-300 inline-flex items-center font-bold ${selectedCategory === 'gm' ? 'bg-[#343434] text-white' : 'bg-white text-[#737373]'}`} data-category="gm" onClick={() => showCategory('gm')}>
                                Gram
                            </button>
                            <button className={`focus:outline-none visited:outline-none active:outline-none category-button-1 border border-black bg-[#343434] text-[#737373] m-1 px-4 py-2 rounded-lg transition-colors duration-300 inline-flex items-center font-bold ${selectedCategory === 'kg' ? 'bg-[#343434] text-white' : 'bg-white text-[#737373]'}`} data-category="kg" onClick={() => showCategory('kg')}>
                                Kilogram
                            </button>
                            <button className={`focus:outline-none visited:outline-none active:outline-none category-button-1 border border-black bg-[#343434] text-[#737373] m-1 px-4 py-2 rounded-lg transition-colors duration-300 inline-flex items-center font-bold ${selectedCategory === 'li' ? 'bg-[#343434] text-white' : 'bg-white text-[#737373]'}`} data-category="li" onClick={() => showCategory('li')}>
                                Litre
                            </button>
                ...
                <div className="w-full mt-5">
                    <div className="mx-5">
                        ...
                        {selectedCategory === 'kg' && (
                            <div className="flex flex-col">
                            {KilogramOptions.map((option, index) => (
                                <div key={index} className="my-5">
                                    <div className='flex justify-between'>
                                    <p className="text-[4vw] text-[#094446] font-bold">{option.amount}</p>
                                    <div className="checkbox-wrapper-13">
...
export default Optionalsweight;
